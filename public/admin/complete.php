...
<body>
    ...
    <div class="container w-75 float-left">
        ...
        <div class="text-right">
            ...
            <a href="complete.php"><i class="fa fa-check" aria-hidden="true"> Đơn hàng đã giao</i></a>
        </div>

        <hr>

        <table class="table table-bordered text-center">
            <p class="text-primary m-3 title text-center text-title">Đơn hàng đã giao</p>
            <thead>
                <tr>
                    <th>Mã đơn hàng</th>
                    <th>Người mua</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <p class="text-primary"> Đã giao</p>
                    </td>
                </tr>
                <?php } endforeach ?>
            </tbody>
