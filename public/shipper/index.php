...
<body>
    ...
    <div class="container w-75 float-left">
        ...
        <div class="row text-center">
            <div class="col-3">
                <a href="#" class="col-6  btn btn-outline-info mw-100">
        ...
        <div class="row text-center">
            ...
            <div class="col-3">
                <a href="manage_order.php" class="col-6  btn btn-outline-info mw-100">
                    ...
                    <p class="text-manage">Đơn hàng chờ giao
                        <b>(<?php echo htmlspecialchars($order->countOrderWatting()); ?>)</b>
                    </p>
                </a>
            </div>
            <div class="col-3">
                <a href="complete.php" class="col-6  btn btn-outline-info mw-100">
                    <i class="fa fa-comments p-3 text-danger" aria-hidden="true" style="font-size: 80px;"> </i>
                    <p class="text-manage"> Đơn hàng đã giao
                        <b>(<?php echo htmlspecialchars($order->countOrderComplete()); ?>)</b>
                    </p>
                </a>
            </div>
            <div class="col-3"></div>
